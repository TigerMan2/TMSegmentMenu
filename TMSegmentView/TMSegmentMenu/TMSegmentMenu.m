...
/// 配置信息
@property (nonatomic, strong) TMSegmentStyle *segmentStyle;
/// 代理
@property (nonatomic, weak) id <TMSegmentMenuDelegate> delegate;
/// 上次index
                 ...
                 currentIndex:(NSInteger)currentIndex
{
    ...
    TMSegmentMenu *menu = [[TMSegmentMenu alloc] initWithFrame:frame];
    menu.titles = titles;
...
- (TMScrollView *)scrollView {
    if (!_scrollView) {
        _scrollView = [[TMScrollView alloc] init];
